...
/**
 * WORK IN PROGRESS; DO NOT USE THIS CLASS YET! TODO finish it.
 * 
...
public final class ValidationAjaxHandler extends DojoAjaxHandler
{
	 ...
	 * 
	 * @param eventName
	 *            name of the event to attach to, e.g. 'onchange'
	 */
	...
	public final void onComponentTag(final ComponentTag tag)
	{
		...
		final String attributeValue = "javascript:validate('" + getCallbackUrl() + "', '"
