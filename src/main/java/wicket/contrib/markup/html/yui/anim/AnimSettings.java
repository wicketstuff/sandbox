...
public class AnimSettings implements Serializable{
	 ...
	 * @return
	 */
	public static AnimSettings getDefault(String easing, double duration, int maxSelection, ArrayList animSelectOptionList){
	 ...
	 * @return
	 */
	public static AnimSettings getDefault(String easing, double duration, int maxSelection, String message, ArrayList animSelectOptionList){
		AnimSettings settings= new AnimSettings();
	...
	public void setImageResources(ArrayList animSelectOptionList){
		for(int i=animSelectOptionList.size()-1; i>=0; i--){
			YuiImage defaultImg= ((AnimOption)animSelectOptionList.get(i)).getDefaultImg();
			YuiImage defaultImgOver= ((AnimOption)animSelectOptionList.get(i)).getDefaultImgOver();
			YuiImage selectedImg= ((AnimOption)animSelectOptionList.get(i)).getSelectedImg();
			YuiImage selectedImgOver= ((AnimOption)animSelectOptionList.get(i)).getSelectedImgOver();
			
			
			ResourceReference defaultImgRR = new PackageResourceReference(AnimSettings.class, defaultImg.getFileName());
			ResourceReference defaultImgOverRR = new PackageResourceReference(AnimSettings.class, defaultImgOver.getFileName());
			ResourceReference selectedImgRR = new PackageResourceReference(AnimSettings.class, selectedImg.getFileName());
			ResourceReference selectedImgOverRR = new PackageResourceReference(AnimSettings.class, selectedImgOver.getFileName());
