...
/**
 * AjaxHandler that can be used to update and rerender components on a set
 * event.
 * 
...
public abstract class DojoUpdateHandler extends DojoAjaxHandler {
	 ...
	 * 
	 * @return Component array containing Components to be updated. NOTE:
	 *         currently only supports 1 component.
	 */
	...
	protected IResourceStream render(final Component[] components) {
		...
		StringBufferResourceStream response = new StringBufferResourceStream(
				"text/plain");
