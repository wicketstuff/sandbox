...
public abstract class AbstractColumn implements IGridColumn {
	...
	/**
	 * Sets the initial size for this column. The unit depends on {@link #setSizeUnit(SizeUnit)}.
	 ...
	 * 
	 * @param reorderable
	 *            <code>true</code> if the column will be reorderable, <code>false</code>
	 *            otherwise
	 * @return <code>this</code> (useful for method chaining)
	 */
	 ...
	 * @param resizable
	 *            <code>true</code> if the column will be resizable, <code>false</code>
	 *            otherwise
	 * @return <code>this</code> (useful for method chaining)
	 */
	...
	/**
	 * Sets whether the text in column will be wrapped when it is too long to fit the column (<code>false</code>
	 * by default).
	 * 
	 * @param wrapText
