...
import wicket.contrib.authorization.strategies.role.annotations.AuthorizeAction;
...
public class AnnotationsPanelsPage extends WebPage
{
   ...
   */
  @AuthorizeAction(action = Action.RENDER, roles = { UserRole.class, AdminRole.class })
   ...
   */
  @AuthorizeAction(action = Action.RENDER, roles = AdminRole.class)
