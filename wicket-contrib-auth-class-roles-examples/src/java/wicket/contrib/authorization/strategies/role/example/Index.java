...
import wicket.contrib.authorization.strategies.role.example.pages.AdminAnnotationsBookmarkablePage;
import wicket.contrib.authorization.strategies.role.example.pages.AdminAnnotationsInternalPage;
import wicket.contrib.authorization.strategies.role.example.pages.AdminBookmarkablePage;
import wicket.contrib.authorization.strategies.role.example.pages.AdminInternalPage;
import wicket.contrib.authorization.strategies.role.example.pages.AnnotationsPanelsPage;
import wicket.contrib.authorization.strategies.role.example.pages.PanelsPage;
