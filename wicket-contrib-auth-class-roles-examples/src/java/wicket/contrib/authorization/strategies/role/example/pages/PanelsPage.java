 ...
 * the License.
 */
package wicket.contrib.authorization.strategies.role.example.pages;

import wicket.contrib.authorization.strategies.role.example.AdminRole;
import wicket.contrib.authorization.strategies.role.example.UserRole;
import wicket.contrib.authorization.strategies.role.metadata.MetaDataRoleAuthorizationStrategy;
...
public class PanelsPage extends WebPage
{
  ...
  public PanelsPage()
  {
    ...
    MetaDataRoleAuthorizationStrategy.authorize(forAdminsAndUsers, RENDER, AdminRole.class);
    MetaDataRoleAuthorizationStrategy.authorize(forAdminsAndUsers, RENDER, UserRole.class);
    
    ForAdmins forAdmins = new ForAdmins("forAdminsPanel");
    // authorise role admin (and thus deny everyone else) for the
    // Component.RENDER action
    MetaDataRoleAuthorizationStrategy.authorize(forAdmins, RENDER, AdminRole.class);
    add(forAdmins);
  }
