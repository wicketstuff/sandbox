...
import org.wicketstuff.jmx.markup.html.tree.OperationExecuteButton;
...
public class OperationDetailPanel extends DetailPanel
{
	...
	public OperationDetailPanel(String id, JmxMBeanWrapper bean, final MBeanOperationInfo operation)
	{
		...
		final MultiLineLabel resultLabel = new MultiLineLabel("result");
		...
		form.add(new OperationExecuteButton("operationName", form, bean, operation, map)
		{
			...
			protected void onSubmit(AjaxRequestTarget target, Object result)
			{
				...
				{
					messageModel = new StringResourceModel("jmx.invocation.exception.multiline",
							this, null, new Object[] { result });
				}
				else
				{
				...
				target.addComponent(OperationDetailPanel.this);
			}
