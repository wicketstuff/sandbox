...
public class JpaGeneralRepository extends JpaDaoSupport implements GeneralRepository {
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#getAllAsList(java.lang.Class)
	 */
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#add(org.domdrides.entity.Entity)
	 */
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#getAll(java.lang.Class)
	 */
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#remove(org.hibernate.type.EntityType)
	 */
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#update(org.hibernate.type.EntityType)
	 */
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.iolite.persistence.provider.GeneralRepository#size(java.lang.Class)
	 */
