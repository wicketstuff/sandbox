 ...
 * @param <T>
 */
public class ImmediateRadioChoice<T> extends RadioChoice<T>
{
	 ...
	 * @param list
	 */
	public ImmediateRadioChoice(MarkupContainer parent, String id, IModel<T> model, List<T> list)
	{
		super(parent, id, model, list);
