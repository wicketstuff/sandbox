...
public class TooltipPanel extends Panel
{
	 ...
	 * openTag) { //super.onComponentTagBody(markupStream, openTag); //write
	 * tooltip unique IFRAME in order to prevent //MSIE problems with windowed
	 * controlers and z-indices System.out.println("hier");
	 * replaceComponentTagBody(markupStream, openTag, "<IFRAME id='" +
	 * getIFrameID() + "' style='visibility: hidden; LEFT: 0px; POSITION:
	 * absolute; TOP: 0p' frameBorder='0' scrolling='no'></IFRAME>");
	 *  }
	 * 
	 *//**
		 ...
		 */
	/*
	 * public WebMarkupContainer getIframe() { return
	 * ((Tooltip)getParent()).getIframe(); }
	 */
