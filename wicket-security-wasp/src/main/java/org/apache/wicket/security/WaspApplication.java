...
public interface WaspApplication
{
	...
	/**
	 * Returns the factory that will be used to create strategys for each session. There
	...
	/**
	 * Returns factory for action creation / tanslation. There is only one factory for
	 * each application. Can not be null.
	 * @return a factory.
	 */
