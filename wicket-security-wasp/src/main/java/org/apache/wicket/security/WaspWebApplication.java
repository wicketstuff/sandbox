 ...
 * @author marrink
 */
public abstract class WaspWebApplication extends WebApplication implements ISessionFactory, WaspApplication
{
	 ...
	 * sets itself up as a {@link ISessionFactory}.
	 */
	...
	/**
	 * Called by the {@link WaspWebApplication#init()}. use this to create and initialize your factory.
	 * The factory created here should be returned when calling {@link WaspApplication#getStrategyFactory()}.
	 * @see WaspApplication#getStrategyFactory()
	 */
	protected abstract void setupStrategyFactory();
	/**
	 * Called by the {@link WaspWebApplication#init()}. use this to create and initialize your factory.
	 * The factory created here should be returned when calling {@link WaspApplication#getActionFactory()}.
