 ...
 * button that performs a AJAX call to a backend wicket resource.
 * In order to use this plugin you have to download jazzy spellchecker <a href="http://jazzy.sourceforge.net/">Jazzy</a>.
 * 
...
public class SpellCheckPlugin extends Plugin
{
	...
	public SpellCheckPlugin()
	{
		...
		Application.get().getSharedResources().add(TinyMCEPanel.class, resourceKey, null, null,
