...
class JazzySpellChecker extends WebResource
{
	...
	private void handleEmptyCheckList(StringBufferResourceStream resourceStream, final String cmd,
			final String id)
	{
		respond(null, cmd, id, resourceStream);
	}

	private void doSuggest(StringBufferResourceStream resourceStream, final String cmd,
			final String id, final String check)
	{
	...
	private void doSpell(StringBufferResourceStream resourceStream, final String cmd,
			final String id, final String check)
	{
		final SpellChecker checker = new SpellChecker(dict);
