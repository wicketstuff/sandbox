...
//    }
    ...
    private String collectionAsString(Collection<Control> wrappers) {
        StringBuffer buffer = new StringBuffer();
        for (Control control : wrappers) {
            if (buffer.length() > 0) {
                buffer.append(", ");
            }
    ...
    void addToolbarAlign(StringBuffer buffer) {
        if (toolbarAlign != null) {
            buffer.append(",\n\t").append("theme_advanced_toolbar_align : ").append("\"").append(toolbarAlign.name()).append("\"");
        }
    }

    void addToolbarLocation(StringBuffer buffer) {
        if (toolbarLocation != null) {
            buffer.append(",\n\t").append("theme_advanced_toolbar_location : ").append("\"").append(toolbarLocation.name()).append("\"");
        }
    }

    void addStatusbarLocation(StringBuffer buffer) {
        if (statusbarLocation != null) {
            buffer.append(",\n\t").append("theme_advanced_statusbar_location : ").append("\"").append(statusbarLocation.name()).append("\"");
        }
    }
    ...
    private String getSimpleSettings() {
        ...
        // tinymce mode
        buffer.append("\n\tmode : ").append("\"").append(mode.name()).append("\"").append(", ");

        // tinymce theme
        buffer.append("\n\ttheme : ").append("\"").append(theme.name()).append("\"");
