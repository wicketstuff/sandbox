...
Wicket.DateLocale.prototype = {
	initialize : function(locale) {
	  ...
	  this.shortMonths = ["ינו","פבר","מרץ","אפר","מאי","יונ","יול","אוג","ספט","אוק","נוב","דצמ"];
	  this.weekdays = ["ראשון","שני","שלישי","רביעי","חמישי","שישי","שבת"];
	  this.shortWeekdays = ["ראש","שני","שלי","רבי","חמי","שיש","שבת"];
	  this.firstDayOfWeek = 0;
	  this.weekNumbering = "ISO";
	  if (locale) {
