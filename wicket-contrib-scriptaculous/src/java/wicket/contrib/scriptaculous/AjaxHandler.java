 ...
 */
public abstract class AjaxHandler extends AbstractBehavior implements
                IBehaviorListener, IHeaderContributor {
        ...
        public final void bind(Component hostComponent) {
                if (hostComponent == null) {
                        throw new IllegalArgumentException(
                                        "Argument hostComponent must be not null");
                }
        ...
        public final String getBodyOnLoad() {
                ...
                if (staticContrib != null) {
                        return (contrib != null) ? staticContrib + contrib
                                        : staticContrib;
                }
                return contrib;
        }
        ...
        public final String getCallbackUrl() {
                ...
                return getComponent().urlFor(IBehaviorListener.INTERFACE)
                                + "&"
         ...
         * rendering the component tag. Use this method e.g. to bind to
         * javascript event handlers of the tag
         * 
         * @param tag
         ...
         */
        public void onRendered(Component hostComponent) {
                onComponentRendered();
        }
        ...
        protected void addJsReference(Response r, PackageResourceReference ref) {
                CharSequence url = getComponent().getPage().urlFor(ref);
                r.write("\t<script language=\"JavaScript\" type=\"text/javascript\" src=\"");
                r.write(url);
                r.write("\"></script>\n");
        }

        /**
         * Gets the onload statement(s) for the body component. Override this
         * method to provide custom contributions.
         * 
        ...
        /**
         * Gets the response to render to the requester. This is used by
         * AjaxHandler default request target implementation,
         ...
         * get the bound host component by calling getComponent.
         */
        protected void onBind() {
        }

        /**
         * Called to indicate that the component that has this handler
         * registered has been rendered. Use this method to do any cleaning up
         * of temporary state
         */
        ...
        /**
         * Respond to this request. If you override this method, make sure you
         * set a proper request target (call
        ...
        protected void respond() {
                ...
                if (resourceStream != null) {
                        ...
                        requestCycle.setRequestTarget(EmptyRequestTarget
                                        .getInstance());
                }
        }
