...
public class MFXAccordion extends Panel {
	private List tabs = new ArrayList();
	private String PANEL_ID = "content";
	private CompressedResourceReference AC_CSS = 
		new CompressedResourceReference(MFXAccordion.class,"MFXAccordion.css");
	
	public MFXAccordion(String id, List tabs) {
		super(id);
...
//	}, $('accordion'));
	...
	protected class MFXTab extends WebMarkupContainer {
		...
		public MFXTab(String id,ITab tab) {
			super(id);
			Label title;
