...
public class MFXFontResizer extends AbstractRequireMooStatelessBehavior {
	...
	public MFXFontResizer(int size) {
		this.size = size;
	}
	
	public MFXFontResizer(int size,int maxSize) {
		this.size = size;
	}
	...
	public MFXFontResizer setContainer(String container) {
	...
	public MFXFontResizer setTag(String tag) {
		this.tag = tag;
		return this;
	}
	...
	public MFXFontResizer setMfxOptions(MFXOptions mfxOptions) {
