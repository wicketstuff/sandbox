...
public class MFXTips extends AbstractRequireMooStatelessBehavior {
	...
	private static final ResourceReference MOOBUBBLE = 
		new ResourceReference(MFXTips.class,"bubble.png");
	private String tip;
	...
	private String renderMooCSS() {
		...
		str+=".tool-text { font-size: 11px; padding: 4px 8px 8px; background: url("+getResource(MOOBUBBLE)+") bottom right; }";
		str+="</style>";
		return str;
	}
	
	private String getResource(ResourceReference ref) {
	...
	/* (non-Javadoc)
	 * @see wicket.contrib.mootools.AbstractRequireMooStatelessBehavior#onComponentTag(org.apache.wicket.Component, org.apache.wicket.markup.ComponentTag)
	 */
	 ...
	 * @return
	 */
	public MFXTips setMfxOptions(MFXOptions mfxOptions) {
