...
import org.apache.wicket.cluster.pagestore.ClusteredPageStore;
import org.apache.wicket.cluster.pagestore.PageStoreComponent;
import org.apache.wicket.cluster.pagestore.PageStoreMessage;
...
public class ClusteredDiskPageStore extends DiskPageStore implements ClusteredPageStore {
	...
	public ClusteredDiskPageStore(int maxSizePerPagemap, int maxSizePerSession, int fileChannelPoolCapacity) {
		...
		id = PageStoreComponent.registerPageStore(application.getServletContext(), application.getApplicationKey(), this);
