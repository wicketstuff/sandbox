 ...
 * the License.
 */
package wicket.contrib.authorization.strategies.role.annotations;
  ...
  public @interface AuthorizeAction
{
   ...
   *
   * @return the roles for this action. The default is Role.EVERYONE
   *         (annotations do not allow null default values)
   */
  Class[] roles() default wicket.contrib.authorization.strategies.role.Role.EVERYONE.class;
}