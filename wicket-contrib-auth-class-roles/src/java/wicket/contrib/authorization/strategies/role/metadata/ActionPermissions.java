 ...
 * be granted access to a given action via authorize(Action, Role role) and
 * denied access via unauthorize(Action, Role role). All permissions can be
 ...
 * @author Gili Tzabari
 */
public final class ActionPermissions implements Serializable
{
