...
import wicket.addons.hibernate.dao.CategoryDAOImpl;
import wicket.addons.hibernate.dao.CategoryDAO;
 ...
 */
public abstract class BaseCategoryDAOImpl extends wicket.addons.hibernate.dao._RootDAO implements BaseCategoryDAO
{
    ...
    {
		return wicket.addons.hibernate.Category.class;
	}
	public wicket.addons.hibernate.Category load(int key)
		throws DataAccessException {
		return (wicket.addons.hibernate.Category) load(getReferenceClass(), new java.lang.Integer(key));
	}
