...
public class InputBehavior implements IBehavior {
	public void detachModel(Component arg0) {
	}

	public void rendered(Component arg0) {
	}

	private static ResourceReference JAVASCRIPT = new CompressedResourceReference(
			InputBehavior.class, "wicket-contrib-input-events.js");

	private Input input = null;

	public InputBehavior(Input input) {
		this.input = input;
