 ...
 * annotated with {@link MountDefinition}.  {@link org.wicketstuff.annotation.strategy.MountMixedParam} is a good
 * example of this type of annotation.
 *
 ...
 * of the implementation of {@link org.apache.wicket.protocol.http.request.WebRequestCodingStrategy#getMountEncoder}
 * returns the first mount that matches the given Page.  Thus, when determining which path to
