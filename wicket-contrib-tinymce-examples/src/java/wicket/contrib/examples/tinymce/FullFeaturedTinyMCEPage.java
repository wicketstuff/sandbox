...
public class FullFeaturedTinyMCEPage extends TinyMCEBasePage
{
	...
	public FullFeaturedTinyMCEPage()
	{
		...
		settings.add(TinyMCESettings.newdocument, TinyMCESettings.Toolbar.first,
				TinyMCESettings.Position.before);
		settings.add(TinyMCESettings.separator, TinyMCESettings.Toolbar.first,
				TinyMCESettings.Position.before);
		settings.add(TinyMCESettings.fontselect, TinyMCESettings.Toolbar.first,
				TinyMCESettings.Position.after);
		settings.add(TinyMCESettings.fontsizeselect, TinyMCESettings.Toolbar.first,
				TinyMCESettings.Position.after);
		...
		settings.add(TinyMCESettings.cut, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.before);
		settings.add(TinyMCESettings.copy, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.before);
		...
		settings.add(pastePlugin.getPasteWordButton(), TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.before);
		settings.add(TinyMCESettings.separator, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.before);
		...
		settings.add(previewPlugin.getPreviewButton(), TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.after);
		settings.add(zoomPlugin.getZoomButton(), TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.after);
		settings.add(TinyMCESettings.separator, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.after);
		settings.add(TinyMCESettings.forecolor, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.after);
		settings.add(TinyMCESettings.backcolor, TinyMCESettings.Toolbar.second,
				TinyMCESettings.Position.after);
		...
		settings.add(iespellPlugin.getIespellButton(), TinyMCESettings.Toolbar.third,
				TinyMCESettings.Position.after);
		settings.add(flashPlugin.getFlashButton(), TinyMCESettings.Toolbar.third,
				TinyMCESettings.Position.after);
		settings.add(TinyMCESettings.separator, TinyMCESettings.Toolbar.third,
				TinyMCESettings.Position.after);
