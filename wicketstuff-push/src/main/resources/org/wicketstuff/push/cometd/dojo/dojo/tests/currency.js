	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "fr,zh,en,de,zh-tw,en-us,pt,en-au,ROOT,en-ca,es,ja,it,ko");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "fr,ROOT,zh-cn,zh,en,es-es,de,zh-tw,en-us,pt,ja-jp,en-au,es,ko-kr,ja,de-de,it,en-gb,ko");
				}
			},
			runTest: function(t){
