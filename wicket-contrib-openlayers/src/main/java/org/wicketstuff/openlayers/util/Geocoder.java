 ...
 * the License.
 */
package org.wicketstuff.openlayers.util;
...
public class Geocoder {
	...
	public LonLat decode(String response) throws GeocoderException {
		...
		return new LonLat(Double.parseDouble(latitude), Double
