 ...
 */
public abstract class ClickListener extends EventListenerBehavior
{
	 ...
	 */
	protected abstract void onClick(AjaxRequestTarget target, LonLat latLng, Overlay overlay);
}